#!/bin/bash
# Installation script for Leafmap QGIS Plugin
#
# Usage:
...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        --help|-h)
            ...
            echo "  --name, -n NAME   Plugin folder name (default: qgis_leafmap)"
...
if [[ "$OSTYPE" == "linux-gnu"* ]]; then
    ...
    echo "Please manually copy the leafmap folder to your QGIS plugins directory."
    exit 1
fi
