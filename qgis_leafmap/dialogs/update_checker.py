"""
Update Checker Dialog for Leafmap Plugin
...
GITHUB_REPO = "opengeos/qgis-leafmap-plugin"
GITHUB_BRANCH = "main"
PLUGIN_PATH = "qgis_leafmap"
...
class DownloadWorker(QThread):
    ...
    def run(self):
        ...
        try:
            ...
            temp_dir = tempfile.mkdtemp(prefix="leafmap_update_")
            ...
            # The structure will be: repo-main/qgis_leafmap/
            extracted_plugin_dir = None
            for root, dirs, files in os.walk(extract_dir):
                if "metadata.txt" in files and "qgis_leafmap.py" in files:
            ...
            try:
                ...
                def is_valid_plugin_dir(path):
                    ...
                    ) and os.path.exists(os.path.join(path, "qgis_leafmap.py"))
...
class UpdateCheckerDialog(QDialog):
    ...
    def __init__(self, plugin_dir, parent=None):
        ...
        self.setWindowTitle("Leafmap Update")
    ...
    def _setup_ui(self):
        ...
        # Header
        header_label = QLabel("Leafmap Update Checker")
        header_font = QFont()
    ...
    def _on_download_finished(self, install_path):
        ...
        QMessageBox.information(
            self,
            "Update Complete",
            f"Leafmap has been updated to version {self.latest_version}.\n\n"
